#!/usr/bin/env python3
"""
Enhanced RAG System with Better Error Handling and Fallback Mechanisms
This system will work with both original and improved embeddings
"""
...
class EnhancedRAGSystem:
    def __init__(self):
        ...
        self.storage_configs = [
            {
                'path': "./qdrant_storage_v2",
                'collection': "pdf_embeddings_v2",
                'name': "Improved V2"
            },
            {
                'path': "./qdrant_storage", 
        ...
        self.api_key = "AIzaSyCFmWEAywTYuMuRKUZBgpZ6MQ5v7Q7EDHw"
        
        # Retrieval settings optimized for better performance
        self.primary_limit = 100
        self.top_k_to_use = 20
        self.score_threshold_primary = 0.2  # Lower threshold to get more results
        self.min_text_length = 30
        self.max_text_per_doc = 1000
