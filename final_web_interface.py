...
import os
from final_working_rag import FinalWorkingRAG

app = Flask(__name__)

# Initialize RAG system
try:
    rag_system = FinalWorkingRAG()
    system_ready = True
        ...
        function askQuestion() {
            ...
            .then(data => {
                if (data.error) {
                    ...
                    answerDiv.innerHTML = '<strong>✅ Answer:</strong><br><br>' + data.answer.replace(/\\n/g, '<br>');
                }
...
if __name__ == '__main__':
    print("🚀 Starting Document Q&A Web Interface...")
